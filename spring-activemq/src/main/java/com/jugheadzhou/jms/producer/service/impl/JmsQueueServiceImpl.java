...
import com.jugheadzhou.jms.producer.thread.QueueThread;
...
@Slf4j
@Service
public class JmsQueueServiceImpl implements IJmsQueueService {
    ...
    public void send(String destination, Object message) {
        ...
        QueueThread queueThread = new QueueThread(this.jmsTemplate, destination, message);

        log.info("开始执行队列线程,目的地是{}",destination);
        this.executorService.execute(queueThread);
    }
    /**
